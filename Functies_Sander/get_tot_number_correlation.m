function number_correlation = get_tot_number_correlation(gs_mps, pspace, trivspace, fusion_trees, site_number, filling, fermion, max_dist)
...
%     disp(reshape(double(O), 16, 16));
    ...
    N_down = fill_tensor(N_down, num2cell([0 1 1 2]));
    N_up = fill_tensor(N_up, num2cell([0 1 1 2]));
