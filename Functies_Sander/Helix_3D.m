function [gs_mps, gs_energy] = Helix_3D(N, delta, trunc, maxiter, vumps_way, stag_h_field, starting_name, final)
    doPath
    ...
    if trunc_tot
        naam = '3D_Helix_vumps_' + string(P) + '_' + string(Q) + '_delta_' + string(delta) + '_trunctotdim_' + string(trunc) + '_stagh_' + string(stag_h_field);
    else
        naam = '3D_Helix_vumps_' + string(P) + '_' + string(Q) + '_delta_' + string(delta) + '_truncbond_' + string(trunc{1}) + '_cut_' + string(trunc{2}) + '_stagh_' + string(stag_h_field);
    end
